...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-8 space-y-4">
      ...
      <p className="text-gray-600 dark:text-gray-300">Welcome to the admin portal, {userData?.name || 'Admin'}.</p>
      ...
      <p className="text-gray-600 dark:text-gray-300">Here you can manage users, roles, and school settings.</p>
    </div>
  );
}
