...
export default function ParentDashboard() {
  ...
  return (
    <div className="p-8 space-y-4">
      <h1 className="text-3xl font-serif font-bold text-gray-900 dark:text-white">Parent Dashboard</h1>
      <p className="text-gray-600 dark:text-gray-300">Welcome to the parent portal, {userData?.name || 'Parent'}.</p>
      ...
      <p className="text-gray-600 dark:text-gray-300">Here you can monitor academic progress and attendance.</p>
    </div>
  );
}
